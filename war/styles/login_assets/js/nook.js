...
$(function() {
    ...
    var vid = $("#Distar-video").get(0);

    $('#Distar-video-play').click(function(event) {
        event.preventDefault();
        if (vid.paused) {
            vid.play();
        } else {
    ...
    $('#Distar-video-volume').click(function(event) {
        event.preventDefault();
        if (vid.muted) {
            vid.muted = false;
        } else {
...
$(function() {
    ...
    var latitude = 13.875033,
        longitude = 100.427549,
        map_zoom = 14;

    //google map custom marker icon - .png fallback for IE11
    var is_internetExplorer11 = navigator.userAgent.toLowerCase().indexOf('trident') > -1;
    var marker_url = (is_internetExplorer11) ? 'styles/login_assets/images/cd-icon-location.png' : 'styles/login_assets/images/cd-icon-location.png';

    //define the basic color of your map, plus a value for saturation and brightness
    var main_color = '#3e8ae6',
        saturation_value = -10,
        brightness_value = 2;
    ...
    $("#contactForm").validate({
        ...
        messages: {
            name: {
                ...
                minlength: "อย่างน้อย 2 ตัวอักษร",
            ...
            phone: {
                ...
                digits: "เฉพาะตัวเลขเท่านั้น (ไม่มีช่องว่าง)",
                minlength: "อย่างน้อย 10 ตัวอักษร",
                maxlength: "มากสุด 15 ตัวอักษร"
            },
            message: {
        ...
        success: function(label) {
            label.addClass("valid").text("สมบูรณ์แบบ!");
        },
        submitHandler: function(element) {
            ...
            $(ajaxform).find('[name="submit"]').html('<i class="fa fa-circle-o-notch fa-spin fa-fw"></i> กำลังส่งข้อความถึงเรา...');
                ...
                success: function(response) {
                    if (response.type == 'success') {
                        ...
                        $(ajaxform).each(function() {
                            this.reset();
                            $(this).find('[name="submit"]').html('<i class="fa fa-paper-plane fa-fw"></i> ส่งข้อความถึงเรา');
                        ...
                        $(ajaxform).find('[name="submit"]').html('<i class="fa fa-paper-plane fa-fw"></i> ส่งข้อความถึงเรา');
                    }
                }
            });
