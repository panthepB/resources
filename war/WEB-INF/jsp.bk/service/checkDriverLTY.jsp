...
<div class="right_col" role="main">
		...
		<form:form method="POST" commandName="searchForm"
			...
			<div class="panel-body">
				<form role="form">
					...
					<div class="form-group">
						</br> <input type="button" value="Google map" class="btn btn-success"
							onclick="show('map');"> <input type="button"
							value="Here map" class="btn btn-success" onclick="show('map2');">
	...
	// 				 document.getElementById("id3").style.display="none";
				...
				<script async defer
					src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCL7Hd7GM6SEaNZ4BDtwMwPDnIPB7ty2-8&callback=initMap">
