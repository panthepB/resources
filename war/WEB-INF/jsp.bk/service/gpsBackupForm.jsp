...
<link rel="stylesheet"
	href="/resources/bootstrap-datetimepicker.min.css">
...
<div class="right_col" role="main">
	...
	<form:form method="POST" commandName="gpsBackupForm"
		action="addHistoryDTK3G.htm">
			...
			<div class="panel-body">
				<form role="form">
					...
					<div class="form-group">
						...
						<form:input path="date_start" id="datepicker"
					...
					<div class="form-group">
						...
						<form:input path="value_record" maxlength="5"
							cssClass="form-control" />
					</div>


					<input type="submit" value="Ok" class="btn btn-success" /> <input
