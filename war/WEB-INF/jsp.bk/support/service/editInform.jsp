		...
		<div class="Post-body">
			<div class="Post-inner">
				<h2 class="PostHeaderIcon-wrapper">
					<span class="PostHeader">แก้ไขการแจ้งงานบริการ</span>
				</h2>
				<div class="PostContent">
					<p>
						<form:form method="POST" commandName="informForm"
							action="editInformNow.htm" name="form1">
							...
							<table width="100%" class="borderTable">
								...
								<tr class="subHeadTable">
									...
									<td colspan="3" align="left" class="subTable"><form:hidden
											path="cusId" />
										<form:hidden path="cusName" />${informForm.cusName}</td>
								</tr>
								<tr class="subHeadTable">
								...
								<tr class="subHeadTable">
									...
									<td colspan="3" align="left" class="subTable"><form:select
											...
											<form:options items="${contacts}" itemLabel="name"
												itemValue="id" />
										</form:select> <c:if test="${informForm.cusId ne 0}">
											<input type="button" value="ผู้ติดต่อใหม่"
												class="styleButton"
												onclick="location.href='editInform.htm?informId=${informForm.informId}&contactId=0'" />
										</c:if></td>
								</tr>
								<tr class="subHeadTable">
								...
								<tr class="subHeadTable">
									...
									<td colspan="3" align="left" class="subTable"><input
										type="text" name="dateService" id="อ"
								...
								<tr>
									<td colspan="4" align="center" valign="top"
										...
										id="proceed" type="submit" class="styleButton"
										value="บันทึกการแก้ไข" /> <input name="resetButton"
										type="reset" class="styleButton" value="เริ่มใหม่" /> <input
										name="cancelButton" type="button" class="styleButton"
										value="ยกเลิก" onclick="location.href='statusInform.htm'" /></td>
								</tr>
							</table>
