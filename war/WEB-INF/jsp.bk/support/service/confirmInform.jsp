									...
									<form:form method="POST" commandName="confirmForm" action="saveConfirmForm.htm" name="form1"><form:hidden path="informId"/>
										...
										<table width="100%" class="borderTable">
											...
											<tr class="subHeadTable">
												...
												<td colspan="3" align="left" valign="top" class="subTable"><form:hidden path="descInform"/>${confirmForm.descInform}</td>
											</tr>
											<tr class="subHeadTable">
											...
											<tr class="subHeadTable">
												...
												<td colspan="3" align="left" class="subTable"><form:select path="supporterId">
