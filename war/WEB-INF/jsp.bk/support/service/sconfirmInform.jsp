						...
						<div class="Post-body">
							<div class="Post-inner">
							    ...
							    <div class="PostContent">
									<p>
									<form:form method="POST" commandName="confirmForm" action="saveConfirmForm.htm" name="form1"><form:hidden path="informId"/><form:hidden path="supporterId"/>
										...
										<table width="100%" class="borderTable">
											...
											<tr class="subHeadTable">
												...
												<td colspan="3" align="left" class="subTable"><c:choose><c:when test="${inform.type eq 1}">การติดตั้ง</c:when><c:otherwise>การบริการ</c:otherwise></c:choose></td>
											</tr>
											<tr class="subHeadTable">
