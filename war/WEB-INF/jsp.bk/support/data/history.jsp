		...
		<div class="Post-body">
			<div class="Post-inner">
				<h2 class="PostHeaderIcon-wrapper">
					<span class="PostHeader">ประวัติการบริการลูกค้า</span>
				</h2>
				<div class="PostContent">
					<p>
						<form:form method="POST" commandName="searchForm"
							action="resHistory.htm">
							<table width="50%" class="borderTable">
								...
								<tr class="subHeadTable">
									...
									<td class="subTable"><form:input path="keyword" /> <input
										type="submit" value="กรอง" class="styleButton" /> <input
										type="reset" value="เริ่มใหม่"
										onclick="location.href='history.htm'" class="styleButton" /></td>
								</tr>
							</table>
						</form:form>
					</p>
					...
					<table width="100%" class="borderTable">
						...
						<c:forEach items="${customerViews}" var="customerView"
							varStatus="n">
