							...
							<dd>
										<form:form method="POST" commandName="loginForm" action="login.htm">
											<table width="100%" border="0">
												...
												<tr>
													<td><input name="proceed" id="proceed" type="submit" class="styleButton" value="เข้าสู่ระบบ"></td>
												</tr>
											</table>
                                     	 </form:form>
<script type="text/javascript">
	...
	//Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'proceed', event:'onclick'}));
					...
					<dl class="curved">
							...
							<dd>
										<p>
											<a href="${companyUrl}"><img src="<c:url value="/images/post_company.jpg"/>" title="ทางเข้าบริษัท" /></a>
										</p>
										<p>
											<a href="http://www.gygar.com/" target="_blank"><img src="<c:url value="/images/post_gygar.jpg"/>" title="ผู้พัฒนาและจัดจำหน่าย" /></a>
										</p>
										<p class="last"> </p>
							</dd>
					</dl>
