                ...
                <div class="container">
                    <div class="navbar-header pull-left">
                        <a class="navbar-brand page-scroll" href="#page-top">
                            <span class="brand-logo"><img src="http://122.155.210.12:88/styles/login_assets/images/logo.png" onerror="this.src='http://122.155.210.12:88/styles/login_assets/images/logo.png'; this.onerror=null;" alt="Distar DLT Send Data" title="Distar DLT Send Data" class="img-responsive"></span>
                        </a>
                    </div>
...
<!--                         </div> -->
            ...
            <section id="products" class="products content-section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="http://122.155.210.12:88/styles/login_assets/images/Report_app.png" class="center-block img-responsive">
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="team-member">
                                        <figure>
                                            <img src="http://122.155.210.12:88/styles/login_assets/images/Nook.JPG" alt="" class="img-responsive">
                                        </figure>
                                ...
                                <div class="col-md-4">
                                    <div class="team-member">
                                        <figure>
                                            <img src="http://122.155.210.12:88/styles/login_assets/images/Benz.JPG" alt="" class="img-responsive">
                                        </figure>
                                ...
                                <div class="col-md-4">
                                    <div class="team-member">
                                        <figure>
                                            <img src="http://122.155.210.12:88/styles/login_assets/images/Top.JPG" alt="" class="img-responsive">
                                        </figure>
                                 ...
                                 <div class="col-md-4">
                                    <div class="team-member">
                                        <figure>
                                            <img src="http://122.155.210.12:88/styles/login_assets/images/Chay.JPG" alt="" class="img-responsive">
                                        </figure>
                                        <h4>Manit ngosorn</h4>
                                        <p>IT Support</p>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="team-member">
                                        <figure>
                                            <img src="http://122.155.210.12:88/styles/login_assets/images/Champ.JPG" alt="" class="img-responsive">
                                        </figure>
                                ...
                                <div class="col-md-4">
                                    <div class="team-member">
                                        <figure>
                                            <img src="http://122.155.210.12:88/styles/login_assets/images/P.JPG" alt="" class="img-responsive">
                                        </figure>
                ...
                <div class="container project-container text-center">
                    <div class="recent-project-carousel owl-carousel owl-theme popup-gallery">
                        <div class="item recent-project">
                            <img src="http://122.155.210.12:88/styles/login_assets/images/gallery/gellery-01.JPG" alt="">
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row client-slider">
                        <div class="item col-xs-4 col-md-2 i">
                            <a href="#" title="#">
                                <img src="http://122.155.210.12:88/styles/login_assets/images/customer-logo.png" class="img-responsive">
                            </a>
                        </div>
                                    ...
                                    <div class="client-testimonials owl-carousel owl-theme">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="client-info">
                                                <img src="http://122.155.210.12:88/styles/login_assets/images/customer-01.JPG" />
                                                <h4>SAM</h4>
                                                <span>แอดมิน</span>
                                            </div>
                                        </div>
            ...
            <section class="cta-one-section content-section alt-bg-light">
                <div class="container">
                    <div class="row text-center">
                        ...
                        <div class="col-md-6">
                            <img src="http://122.155.210.12:88/styles/login_assets/images/monitor.png" class="img-responsive">
                        </div>
                ...
                <div class="container">
                    <div class="row form-container">
                        ...
                        <div class="col-md-8 contact-form">
                            ...
                            <form class="ajax-form" id="contactForm" method="post" action="http://122.155.210.12:88/styles/login_assets/php/contact.php">
                    ...
                    <div class="row text-center">
                        <div class="col-md-12 segment">
                            <a href="#" title="Distar Tracking Web Report">
                                <h2>
                                    <img src="http://122.155.210.12:88/styles/login_assets/images/logo.png" onerror="this.src='styles/login_assets/images/logo.png'; this.onerror=null;" alt="Distar Tracking Web Report" title="Distar Tracking Web Report" class="img-responsive">
                                </h2>
                            </a>
