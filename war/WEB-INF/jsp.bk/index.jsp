...
<body id="home">
			...
			<div class="navbar-header pull-left">
				<a class="navbar-brand page-scroll" href="#page-top"> <span
					class="brand-logo"><img
						src="http://122.155.210.12:88/styles/login_assets/images/logo.png"
						onerror="this.src='http://122.155.210.12:88/styles/login_assets/images/logo.png'; this.onerror=null;"
						alt="Distar DLT Send Data" title="Distar DLT Send Data"
						class="img-responsive"></span>
				</a>
			</div>
			<div class="pull-right">
				<div>
					<form class="form-list" name="login-form" commandName="loginForm"
						action="login.htm" method="post">
						<div class="row">
							<div class="col-md-4">
								<input class="form-control" name="username" type="text"
									id="passwd" placeholder="Username">
							</div>
							<div class="col-md-4">
								<input class="form-control" name="password" type="password"
									id="passwd" value="" placeholder="Password">
							</div>
							<div>
		...
		<div class="carousel-inner">
			<div class="item video-section active">
				...
				<div class="video-controls">
					<a id="video-volume" class="fa fa-volume-off fa-lg" href="#"></a> <a
						id="video-play" class="fa fa-pause fa-lg" href="#"></a>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					...
					<p>Distar แบรนด์ชั้นนำจากประเทศเกาหลี
						ผู้น้ำด้านวัตกรรมและเทคโนโลยีด้านอิเล็กทรอนิกส์ที่ได้รับการยอมรับจากผู้บริโภคทั่วโลกมากกว่า
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-md-12">
					...
					<h3 class="caption gray">DLT Send Data เป็นระบบบริหารจัดการ
						การส่งข้อมูลเข้ากรมขนส่งทางบก]</h3>
				</div>
	...
	<section id="products" class="products content-section">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<img
						src="http://122.155.210.12:88/styles/login_assets/images/Report_app.png"
					...
					<div class="products-container">
						...
						<div class="col-md-12 product-item">
							...
							<div class="media-body">
								...
								<p>เป็นการแสดงข้อมูลรายงานการขับรถเกิดความเร็ว
									หกสดาวสหาดยไาดสไยาดรไำจดกหอมทมแือา่ปดรขดไดาสำไาาหกด</p>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="team-member">
								<figure>
									<img
										src="http://122.155.210.12:88/styles/login_assets/images/Nook.JPG"
						...
						<div class="col-md-4">
							<div class="team-member">
								<figure>
									<img
										src="http://122.155.210.12:88/styles/login_assets/images/Benz.JPG"
										alt="" class="img-responsive">
								</figure>
						...
						<div class="col-md-4">
							<div class="team-member">
								<figure>
									<img
										src="http://122.155.210.12:88/styles/login_assets/images/Top.JPG"
										alt="" class="img-responsive">
								</figure>
						...
						<div class="col-md-4">
							<div class="team-member">
								<figure>
									<img
										src="http://122.155.210.12:88/styles/login_assets/images/Chay.JPG"
										alt="" class="img-responsive">
								</figure>
								<h4>Manit ngosorn</h4>
								<p>IT Support</p>
						...
						<div class="col-md-4">
							<div class="team-member">
								<figure>
									<img
										src="http://122.155.210.12:88/styles/login_assets/images/Champ.JPG"
										alt="" class="img-responsive">
								</figure>
						...
						<div class="col-md-4">
							<div class="team-member">
								<figure>
									<img
										src="http://122.155.210.12:88/styles/login_assets/images/P.JPG"
										alt="" class="img-responsive">
								</figure>
	...
	<section id="portfolio" class="portfolio content-section">
		...
		<div class="container project-container text-center">
			<div
				class="recent-project-carousel owl-carousel owl-theme popup-gallery">
				<div class="item recent-project">
					<img
						src="http://122.155.210.12:88/styles/login_assets/images/gallery/gellery-01.JPG"
						alt="">
				</div>
			...
			<div class="customNavigation project-navigation text-center">
				<a class="btn-prev"><i class="fa fa-angle-left fa-2x"></i></a> <a
					class="btn-next"><i class="fa fa-angle-right fa-2x"></i></a>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="caption white">นี่คือลูกค้าส่วนหนึ่งของเราที่ให้ระบบของ
						Distar Tracking</h3>
				</div>
			</div>
			...
			<div class="row client-slider">
				<div class="item col-xs-4 col-md-2 i">
					<a href="#" title="#"> <img
						src="http://122.155.210.12:88/styles/login_assets/images/customer-logo.png"
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<div class="client-testimonials owl-carousel owl-theme">
								...
								<div class="item">
									<p class="speech">รายงานดูเป็นมาตรฐานดีครับ
										เหมาะกับการทำรายงานให้เจ้านายดูมากๆ สวยครับ</p>
									<div class="client-info">
										<img
											src="http://122.155.210.12:88/styles/login_assets/images/customer-01.JPG" />
										<h4>SAM</h4>
										<span>แอดมิน</span>
									</div>
								</div>
								...
								<div class="item">
									<p class="speech">เยี่ยมเลยครับเรามาสามารถดึงข้อมูลให้นายดูได้หลากหลายครับ
										นายชอบมากเลยครับ</p>
									<div class="client-info">
										<img
											src="http://122.155.210.12:88/styles/login_assets/images/customer-01.JPG" />
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-md-6">
					...
					<h3 class="caption gray">บุคคลผู้ให้ความช่วยเหลือแก่ผู้ใช้ระบบ
						(อัศวิน)</h3>
					<p>อัศวินมีเจ้าหน้าที่ให้ความช่วยเหลือแก่ผู้ใช้ระบบ
						ไม่ว่าจะเป็นปัญหาด้านใดก็ตามที่เกิดขึ้นจากการดำเนินงานของระบบ</p>

					<a href="tel:0917706236" class="btn btn-outlined btn-lg">ติดต่อ
						อัศวิน (091-770-6236)</a>
				</div>

				<div class="col-md-6">
					<img
						src="http://122.155.210.12:88/styles/login_assets/images/monitor.png"
						class="img-responsive">
				</div>
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-md-12">
					...
					<h3 class="caption">ห้อง Monitor
						ที่จะคอยตรวจสอบดูแลระบบให้ท่าน เพื่อให้ท่านได้วางใจ
						เรามีส่วนนี้คอยดูแลให้ครับ</h3>
				</div>

				<div class="col-sm-6 counter-wrap">
					<strong><span class="timer">7</span></strong> <span
						class="count-description">วัน</span>
				</div>

				<div class="col-sm-6 counter-wrap">
					<strong><span class="timer">24</span></strong> <span
						class="count-description">ชั่วโมง</span>
				</div>
	...
	<section class="cta-two-section">
		<div class="container">
			<div class="row">
				<div class="col-sm-9">
					<h3>หรือ!! คุณสามารถเข้าระบบ Realtime Distar tracking
						ได้ที่นี่</h3>
	...
	<section id="contact" class="contact content-section no-bottom-pad">
		<div class="container">
			<div class="row text-center">
				<div class="col-md-12">
					<h2>ต่อต่อเรา</h2>
					<h3 class="caption gray">สามารถติดต่อขอคำปรึกษาหรือให้คำแนะนำเกี่ยวกับระบบ
						เพื่อปรับปรุงและพัฒนาระบบให้ดียิ่งขึ้นและนำไปสู่ความเป็นมาตรฐาน
						อย่ากลัวกลัวที่จะติดต่อเรา</h3>
				</div>
			...
			<div class="row form-container">
				...
				<div class="col-md-8 contact-form">
					...
					<form class="ajax-form" id="contactForm" method="post"
						action="http://122.155.210.12:88/styles/login_assets/php/contact.php">
						<div class="form-group">
							<input type="text" class="form-control" id="name" name="name"
								placeholder="ชื่อ-นามสกลุล" value="" required>
						</div>
						<div class="form-group">
							<input type="email" class="form-control" id="email" name="email"
								placeholder="อีเมล์" value="" required>
						</div>
						<div class="form-group">
							<input type="phone" class="form-control" id="phone" name="phone"
								placeholder="เบอร์โทรศัพท์" value="" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<button type="submit" name="submit" class="btn btn-default">
								<i class="fa fa-paper-plane fa-fw"></i> ส่งข้อความถึงเรา
							</button>
						</div>
					</form>
				</div>
				...
				<div class="col-md-4 contact-address">
					<h3>ที่อยู่</h3>
					<p>
						38/2 ชั้นเอ็ม หมู่ 2 <br />ถนนรัตนาธิเบศร์ ต.บางรักพัฒนา <br />อ.บางบัวทอง
						จ.นนทบุรี <br />11110
					</p>
					<ul>
		...
		<footer>
			<div class="container">
					...
					<div class="col-md-12 segment">
						<a href="#" title="Distar Tracking Web Report">
							<h2>
								<img
									src="http://122.155.210.12:88/styles/login_assets/images/logo.png"
									onerror="this.src='styles/login_assets/images/logo.png'; this.onerror=null;"
									alt="Distar Tracking Web Report"
									title="Distar Tracking Web Report" class="img-responsive">
							</h2>
						</a>
				...
				<div class="row text-center">
					<div class="col-md-12 social segment">
						<h4></h4>
						<a href="www.facebook.com/distartechthailand"><i
							class="fa fa-facebook fa-3x"></i></a> <a
							href="www.youtube.com/user/DistarTechThailand"><i
							class="fa fa-youtube fa-3x"></i></a> <a
							href="www.instagram.com/distartechthailand/"><i
			...
			<div class="copynote">
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center">&copy; 2016. DistarTech
							Thailand. All rights reserved.</div>
