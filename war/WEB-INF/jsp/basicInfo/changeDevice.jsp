...
<!-- 						<input id="tags" class="form-control"> -->
					...
					<div class="form-group">
						...
						<form:input path="vehicleChassisNo" readonly="true" maxlength="25" id="vehicleChassisNo" onkeyup="checkChassisNo();" cssClass="form-control" />
					</div>
					<div class="form-group">
						<label>ประเภทรถ</label>
						<form:select path="vehicleRegisterType" cssClass="form-control">
							<form:options items="${listVehicle}" itemValue="vehicleRegisterType"  itemLabel="decription" readonly="true"/>
						</form:select>
					</div>
					<div class="form-group">
						<label>จังหวัด</label>
