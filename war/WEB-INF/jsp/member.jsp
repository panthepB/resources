                ...
                <div class="col-md-12"  > 
                 <div style="border: 1px solid #ccc; padding: 20px;">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>MHD TG</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <div class="text-left col-xs-3 mar-bot-15">
                                        <label class="label bg-blue"><fmt:formatNumber type="number" maxFractionDigits="2" value="${(mdvrOnline / mdvrTotal)*100}"/>%<i class="fa fa-level-up" aria-hidden="true"></i></label>
                                    </div>
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                ...
                                <div class="progress progress-mini">
                                    <div style="width: ${(mdvrOnline / mdvrTotal)*100}0%;" class="progress-bar bg-blue"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
...
<%-- 						<i class="fa fa-refresh fa-fw" ></i> DTK3G-100T Status : ${DTK3GStatus.status} <span class="pull-right text-muted small" ><em>Lastupdate &nbsp;&nbsp;${DTK3GStatus.size}  &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;  ${DTK3GStatus.timeUpdate}</em> </span>  --%>
						...
						<i class="fa fa-refresh fa-fw"></i> BMTA Status : ${BMTAStatus} <span class="pull-right text-muted small"><em>Lastupdate &nbsp;&nbsp;${BMTASize}    &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;   ${BMTATimeUpdate}</em>
						...
						<i class="fa fa-refresh fa-fw"></i> DISTAR GPS Status : ${TGStatus} <span class="pull-right text-muted small"><em>Lastupdate &nbsp;&nbsp;${TGSize}    &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;   ${TGTimeUpdate}</em>
						</span>
						</a>
	...
	<footer>
		<div class="pull-right">
			Distar Masterfile management &copy;<a href="https://www.distar.co.th">Distar International co.,ltd</a>
		</div>
		<div class="clearfix"></div>
	</footer>
	<!-- /footer content -->
