		...
		<div class="Post-body">
			<div class="Post-inner">
				...
				<div class="PostContent">
					...
					<p>
						<form:form method="POST" commandName="positionForm"
							action="savePosition.htm">
							<table width="90%" class="borderTable">
								<tr class="HeadTable">
									<td colspan="2">ฟอร์มการกำหนดข้อมูลตำแหน่งในระบบ<form:hidden
											path="school" /></td>
								</tr>
								<tr class="subTable">
										...
										type="hidden" id="submitStatus" name="submitStatus" /> <c:choose>
											...
											<c:otherwise>
												...
												<input type="submit" class="styleButton" value="ลบข้อมูล"
													onclick="goSubmit('del');return confirm('คุณแน่ใจจะลบสังกัดนี้หรือไม่');" />
												<input type="button" class="styleButton" value="ยกเลิก"
													onclick="location.href='setPosition.htm'" />
											</c:otherwise>
										</c:choose></td>
								</tr>
							</table>
