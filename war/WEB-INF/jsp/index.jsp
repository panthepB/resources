...
<link href="styles/login_assets/css/plugins/owl.carousel.css"
	rel="stylesheet">
<link href="styles/login_assets/css/plugins/owl.theme.css"
	rel="stylesheet">
<link href="styles/login_assets/css/plugins/owl.transitions.css"
	rel="stylesheet">
<link href="styles/login_assets/css/plugins/animate.css"
	rel="stylesheet">
<link href="styles/login_assets/css/plugins/magnific-popup.css"
	rel="stylesheet">
<link href="styles/login_assets/css/plugins/jquery.mb.YTPlayer.min.css"
	rel="stylesheet">
<link href="styles/login_assets/css/font-awesome.min.css"
	rel="stylesheet">
...
<body id="home">
	...
	<section id="products" class="products content-section">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<img src="styles/login_assets/images/Report_app.png"
	...
	<section class="cta-one-section content-section alt-bg-light">
		<div class="container">
			<div class="row text-center">
				...
				<div class="col-md-6">
					<img src="styles/login_assets/images/monitor.png"
	...
	<section id="contact" class="contact content-section no-bottom-pad">
			...
			<div class="row form-container">
				...
				<div class="col-md-8 contact-form">
					...
					<form class="ajax-form" id="contactForm" method="post"
						action="styles/login_assets/php/contact.php">
		...
		<div id="map2"
			style="width: 100%; height: 500px; background: white; padding: 40px" /></div>
...
//  					var ui = H.ui.UI.createDefault(map, defaultLayers, 'th-TH');
			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-12 segment">
						<a href="#" title="Distar Tracking Web Report">
							<h2>
								<img src="styles/login_assets/images/logo.png"
									onerror="this.src='styles/login_assets/images/logo.png'; this.onerror=null;"
									alt="Distar Tracking Web Report"
				...
				<div class="row text-center">
					<div class="col-md-12 social segment">
						<h4></h4>
						<a href="//www.facebook.com/distarthailand"><i
							class="fa fa-facebook fa-3x"></i></a> <a
							href="//www.youtube.com/channel/UCPZWTOoYbZIDtjxkd1e5CQA"><i
		...
		<script
			src="styles/login_assets/js/plugins/jquery.magnific-popup.min.js"></script>
		...
		<script
			src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDYtwnUdeVub7dMAoLiFupwTI4PprKWzFg"></script>
