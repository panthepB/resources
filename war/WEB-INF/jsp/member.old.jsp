		...
		<div class="section-admin container-fluid"
			...
			<div class="row admin text-center">
				...
				<div class="col-md-12">
					<div style="border: 1px solid #ccc; padding: 20px;">
						<p style="font-size: 18px; text-align: left;">Max online per
							day</p>
						<div class="row">
					...
					<div class="panel panel-default" style="margin: 30px 0">
						...
						<div class="panel-body">
							<div class="list-group">
								...
								<%--     						</c:otherwise> --%>
								<%-- 						</c:choose> --%>
								<i class="fa fa-refresh fa-fw"></i> SCCC Status : ${SCCC.status}
			...
			<footer>
				<div class="pull-right">
					Distar DLT Send data by <a href="https://www.distartech.com">DistarTech
						co.,LTD</a>
				</div>
				<div class="clearfix"></div>
			</footer>
