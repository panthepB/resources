		...
		<div class="Post-body">
			<div class="Post-inner">
				<h2 class="PostHeaderIcon-wrapper">
					<span class="PostHeader">การยืนยันการแจ้งงานบริการ</span>
				</h2>
				<div class="PostContent">
					<p>
						<form:form method="POST" commandName="confirmForm"
							action="saveConfirmForm.htm" name="form1">
							<form:hidden path="informId" />
							<form:hidden path="supporterId" />
							...
							<table width="100%" class="borderTable">
								...
								<tr class="subHeadTable">
									...
									<td colspan="3" align="left" class="subTable"><c:choose>
								...
								<tr class="subHeadTable">
									...
									<td width="30%" align="left" class="subTable">${inform.product.name}</td>
								...
								<tr class="subHeadTable">
									...
									<td colspan="3" align="left" valign="top" class="subTable"><form:hidden
											path="descSupport" />${confirmForm.descSupport}</td>
								</tr>
								<tr class="subHeadTable">
									<td width="20%" align="left">วันนัด</td>
									<td colspan="3" align="left" class="subTable"><input
										type="text" name="dateService" id="dateService"
										value="${confirmForm.dateService}"
								...
								<tr class="subHeadTable">
									...
									<td colspan="3" align="left" class="subTable"><input
										...
										value="${confirmForm.minuteSerivce}"
										dojoType="dijit.form.NumberTextBox"
								...
								<tr class="subHeadTable">
									...
									<td colspan="3" align="left" class="subTable">${inform.supportor.name}</td>
								</tr>
								<tr class="subHeadTable">
								...
								<tr>
									<td colspan="4" align="center" valign="top"
										...
										type="submit" class="styleButton" value="ยืนยันการแจ้งงาน" />
...
<script type="text/javascript">
  ...
  Spring.addDecoration(new Spring.ElementDecoration({elementId : "descInform", widgetType: "dijit.form.SimpleTextarea", widgetAttrs : {style:"width:200px"}}));
</script>
</html>