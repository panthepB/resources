									...
									<p>
										<table width="100%" class="borderTable">
											...
											<tr class="subHeadTable">
												...
												<td colspan="3" align="left" class="subTable">${inform.dayService} วัน</td>
											</tr>
											<tr class="subHeadTable">
												...
												<td colspan="4">
													<table width="100%">
														...
														<tr class="subTable">
															...
															<td align="center"><c:choose><c:when test="${informDetail.status eq 1}">นัดบริการ</c:when><c:when test="${informDetail.status eq 2}">บริการแล้ว</c:when><c:otherwise>เรียบร้อย</c:otherwise></c:choose></td>
														</tr>
														</c:forEach>
													</table>
												</td>
											...
											<tr>
												  <td colspan="4" align="center" valign="top" class="subTable_button"><input name="back" type="button" class="styleButton" value="กลับ" onclick="history.back()" /></td>
								  			</tr>
										</table>
								    </p>
                              </div>
