		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table id="example" class="table table-striped table-bordered" cellspacing="0" width="125%">
						<thead>
							<tr>
...
<!-- 								<th align="center">ส่งข้อมูล</th> -->
								...
								<c:forEach items="${listMasterFile}" var="listMasterFile" varStatus="n">
										...
										<c:choose>
										    <c:when test = "${listMasterFile.dltStatus == 0}">
												...
												<td bgcolor="#FFC0C0" width="12%"><c:out value="${listMasterFile.imei}" /></td>
												...
												<td bgcolor="#FFC0C0" width="10%"><c:out value="${listMasterFile.dltUpdateTime}" /></td>
												<td bgcolor="#FFC0C0" width="10%"><c:out value="${listMasterFile.remark}" /></td>
	<!-- 											<td width="10%"> -->
	...
	<!-- 											</td> -->
										    ...
										    <c:otherwise>
												...
												<td width="10%"><c:out value="${listMasterFile.dltUpdateTime}" /></td>
