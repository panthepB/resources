...
<!-- 								<th align="center">ส่งข้อมูล</th> -->
								...
								<c:forEach items="${listMasterFile}" var="listMasterFile" varStatus="n">
										...
										<c:choose>
										    <c:when test = "${listMasterFile.dltStatus == 0}">
										    	...
										    	<td bgcolor="#FFC0C0" ><c:out value="${listMasterFile.unitId}" /></td>
												<td bgcolor="#FFC0C0" ><c:out value="${listMasterFile.vehicleChassisNo}" /></td>
												<td bgcolor="#FFC0C0" ><c:out value="${listMasterFile.imei}" /></td>
												<td bgcolor="#FFC0C0" ><c:out value="${listMasterFile.vehicleId}" /></td>
												<td bgcolor="#FFC0C0"  ><c:out value="${listMasterFile.provinceCode.provinceName}" /></td>
												<%-- 													<td width="5%"><c:out value="${table[j.index+3]}" /></td> --%>
												<td bgcolor="#FFC0C0" align="center"><c:out value="${listMasterFile.vehicleType}" /></td>
												<td bgcolor="#FFC0C0"  align="center"><c:out value="${listMasterFile.vehicleRegisterType.decription}" /></td>
												<td bgcolor="#FFC0C0" ><c:out value="${listMasterFile.customerName}" /></td>
												<td bgcolor="#FFC0C0" ><c:out value="${listMasterFile.saleName}" /></td>
												
												<td bgcolor="#FFC0C0" ><c:out value="${listMasterFile.dltUpdateTime}" /></td>
												<td bgcolor="#FFC0C0" ><c:out value="${listMasterFile.remark}" /></td>
	<!-- 											<td width="10%"> -->
	...
	<!-- 											</td> -->
										    ...
										    <c:otherwise>
												...
												<td ><c:out value="${listMasterFile.provinceCode.provinceName}" /></td>
												<%-- 													<td width="5%"><c:out value="${table[j.index+3]}" /></td> --%>
												<td  align="center"><c:out value="${listMasterFile.vehicleType}" /></td>
												<td  align="center"><c:out value="${listMasterFile.vehicleRegisterType.decription}" /></td>
