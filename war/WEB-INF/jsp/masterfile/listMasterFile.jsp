										...
										<tr>
											...
											<td width="10%"><a
												...
												class="blue"> <img border="0" alt="Edit"
													src="../img/edit-property-96.png" width="24" height="24"></a>
												<a href="changeDeviceForm.htm?unitId=${table[j.index]}"
												class="red"> <img border="0" alt="Edit"
													src="../img/icons8-transfer-96.png" width="24" height="24"></a>
