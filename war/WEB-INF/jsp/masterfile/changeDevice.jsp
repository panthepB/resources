...
<!-- 						<input id="tags" class="form-control"> -->
						<form:input path="customerName" id="customers" autocomplete="on" maxlength="50" cssClass="form-control" readonly="true"/>
					</div>
					<div class="form-group">
						<label>ชื่อผู้ขาย</label>
						<form:input path="saleName" id="sales" autocomplete="on" maxlength="50" cssClass="form-control" readonly="true"/>
					</div>
					<div class="form-group">
						<label>IMEI</label>
						<form:input path="imei" maxlength="20" id="imei" onkeyup="checkIMEI();" cssClass="form-control" />
						<form:hidden path="oldImei"/>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<form:input path="devNum" maxlength="20" id="devNum"  cssClass="form-control" readonly="true"/>
					</div>
					<div class="form-group">
						<label>ทะเบียนรถ</label>
						<form:input path="vehicleId" id="vehicleId" maxlength="7" cssClass="form-control" readonly="true"/>
					</div>
					<div class="form-group">
						<label>ยี่ห้อรถ</label>
						<form:input path="vehicleType" id="vehicleTypes"  autocomplete="on"maxlength="20" cssClass="form-control" readonly="true"/>
					</div>
					<div class="form-group">
						<label>หมายเลขตัวถัง</label>
						<form:input path="vehicleChassisNo" maxlength="25" id="vehicleChassisNo" onkeyup="checkChassisNo();" cssClass="form-control" readonly="true"/>
					</div>
					<div class="form-group">
...
<%-- 							<form:option value="0430010" label="TXU-31S" /> --%>
					...
					<div class="form-group">
						...
						<form:input path="installDate" cssClass="form-control"  disabled="true"/>
					</div>
					<div class="form-group">
