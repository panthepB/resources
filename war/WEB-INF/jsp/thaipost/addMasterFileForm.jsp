				...
				<form role="form">
					...
					<div class="form-group">
						...
						<form:select path="gpsModel" cssClass="form-control">
							<%-- 							<form:option value="0" label="กรุณาเลือก" /> --%>
							<form:option value="0370001" label="MHD-C8AG (HDD)" />
							<form:option value="0370002" label="MHD-C8SG (SD Card)" />
							<form:option value="0370003" label="DTK-3G100T" />
							<form:option value="0370004" label="TDF-422F" />
							<form:option value="0370005" label="GT06E" />
							<form:option value="0370006" label="TD2-F211" />
						</form:select>
					</div>

					<div class="form-group">
						<label>เครื่องรูดบัตร</label> </br>
